...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route($dashboardRoute) }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200 me-2" style="margin-right: 15px;"/>
                    </a>
                    <a href="{{ route($dashboardRoute) }}" class="text-lg font-bold text-gray-700 dark:text-gray-100">
                        ✈️ The reservation of your dreams
                    </a>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role === 'admin')
                <x-responsive-nav-link :href="route('admin.reports.completed')" :active="request()->routeIs('admin.reports.*')">
                    Reports
                </x-responsive-nav-link>
            @endif
        </div>
