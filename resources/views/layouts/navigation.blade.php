            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route($dashboardRoute) }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" style="margin-right: 8px;" />
                    </a>
                    <a href="{{ route($dashboardRoute) }}">The reservation of your dreams</a>
                </div>
